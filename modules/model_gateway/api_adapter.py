...
def _gateway() -> ModelGatewayAgent:
...
def set_agent_assistance_request(name: str, requested: bool = True, reason: str = "") -> dict[str, Any]:
    return _gateway().set_agent_assistance_request(
...
def list_assistance_requests() -> dict[str, Any]:
    return _gateway().list_assistance_requests()


def list_owned_agent_locations(refresh: bool = False) -> dict[str, Any]:
    return _gateway().list_owned_agent_locations(refresh=bool(refresh))
...
def invoke_endpoint(
    ...
    return _gateway().invoke_endpoint(
        str(endpoint or "").strip(),
        str(prompt or "").strip(),
