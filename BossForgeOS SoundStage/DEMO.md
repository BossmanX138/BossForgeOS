...
## Goal
Demonstrate all required features in one execution flow.

## Steps
1. Build and run executable from INSTALL.md.
...
## Unified Additions
- Devlot PowerShell manager offers direct registry orchestration for system event sounds with backup/rollback workflows in `tools/`.
